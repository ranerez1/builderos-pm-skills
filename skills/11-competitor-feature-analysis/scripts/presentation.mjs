...
function renderComparison(data, dataDir, repoRoot) {
  ...
  const body = `${hero}${insights}${scopeSection}${tableSection}${flows}${notesSection}${docsSection}<footer>Generated by /11-competitor-feature-analysis · ${escapeHtml(data.date || '')}</footer>`;
...
<p><strong>Product difference:</strong> ${escapeHtml(t.productDifference || '')}</p></div>`;
  ...
  const body = `${hero}${insights}${topSection}${tableSection}${strengthsSection}${thumbsSection}<footer>Generated by /11-competitor-feature-analysis · gap analysis · ${escapeHtml(data.date || '')}</footer>`;
